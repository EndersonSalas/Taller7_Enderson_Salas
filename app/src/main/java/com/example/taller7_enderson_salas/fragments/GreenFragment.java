...
public class GreenFragment extends Fragment {
    ...
    private final String TAG= "GreenFragment";
    @Override
    ...
    public void  setupUI (final View view ){
        FloatingActionButton btnNext= (FloatingActionButton) view.findViewById(R.id.floating_next2);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GreenFragmentDirections.Fragmentto3 action = GreenFragmentDirections.fragmentto3();
